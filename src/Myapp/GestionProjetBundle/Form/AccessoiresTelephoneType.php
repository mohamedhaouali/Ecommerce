...
class AccessoiresTelephoneType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Myapp\GestionProjetBundle\Entity\AccessoiresTelephone'
        ));
    }
    ...
    {
        return 'myapp_gestionprojetbundle_accessoirestelephone';
    }
