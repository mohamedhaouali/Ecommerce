...
class CartouchesimprimanteType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Myapp\GestionProjetBundle\Entity\Cartouchesimprimante'
        ));
    }
    ...
    {
        return 'myapp_gestionprojetbundle_cartouchesimprimante';
    }
