...
class classementetarchivageType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Myapp\GestionProjetBundle\Entity\classementetarchivage'
        ));
    }
    ...
    {
        return 'myapp_gestionprojetbundle_classementetarchivage';
    }
