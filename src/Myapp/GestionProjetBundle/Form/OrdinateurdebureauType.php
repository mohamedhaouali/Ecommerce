...
class OrdinateurdebureauType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Myapp\GestionProjetBundle\Entity\Ordinateurdebureau'
        ));
    }
    ...
    {
        return 'myapp_gestionprojetbundle_ordinateurdebureau';
    }
