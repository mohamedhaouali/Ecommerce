...
class DisqueDurExterneType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Myapp\GestionProjetBundle\Entity\DisqueDurExterne'
        ));
    }
    ...
    {
        return 'myapp_gestionprojetbundle_disquedurexterne';
    }
