...
class ComposantinformatiqueType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Myapp\GestionProjetBundle\Entity\Composantinformatique'
        ));
    }
    ...
    {
        return 'myapp_gestionprojetbundle_composantinformatique';
    }
