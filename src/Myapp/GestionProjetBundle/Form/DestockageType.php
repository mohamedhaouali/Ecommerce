...
class DestockageType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
                ...
                ->add('prix1', MoneyType::class,array('required'=>true, 'attr'=> array('placeholder'=>'prix du produit')))
                ->add('disponible')
                ->add('tva')
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Myapp\GestionProjetBundle\Entity\Destockage'
        ));
    }
    ...
    {
        return 'myapp_gestionprojetbundle_destockage';
    }
