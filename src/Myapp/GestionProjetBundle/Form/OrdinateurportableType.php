...
class OrdinateurportableType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Myapp\GestionProjetBundle\Entity\Ordinateurportable'
        ));
    }
    ...
    {
        return 'myapp_gestionprojetbundle_ordinateurportable';
    }
