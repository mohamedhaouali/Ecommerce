...
/**
 * Accessoiresimprimante
 *
 * @ORM\Table(name="accessoiresimprimante")
 * @ORM\Entity(repositoryClass="Myapp\GestionProjetBundle\Repository\AccessoiresimprimanteRepository")
 */
class Accessoiresimprimante
{
    /**
     * @var int
     *
