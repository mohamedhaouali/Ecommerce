...
/**
 * classementetarchivage
 *
 * @ORM\Table(name="classementetarchivage")
 * @ORM\Entity(repositoryClass="Myapp\GestionProjetBundle\Repository\classementetarchivageRepository")
 */
class classementetarchivage
{
    /**
     * @var int
     *
