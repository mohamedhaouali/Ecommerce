 ...
 * Fournituredubureau
 *
 * @ORM\Table(name="fournituredubureau")
 * @ORM\Entity(repositoryClass="Myapp\GestionProjetBundle\Repository\FournituredubureauRepository")
 */
class Fournituredubureau
{
    /**
     * @var int
     *
