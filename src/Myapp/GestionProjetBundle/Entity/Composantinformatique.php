...
/**
 * Composantinformatique
 *
 * @ORM\Table(name="composantinformatique")
 * @ORM\Entity(repositoryClass="Myapp\GestionProjetBundle\Repository\ComposantinformatiqueRepository")
 */
