 ...
 *
 * @ORM\Table(name="accessoires_telephone")
 * @ORM\Entity(repositoryClass="Myapp\GestionProjetBundle\Repository\AccessoiresTelephoneRepository")
 */
class AccessoiresTelephone
{
    /**
     * @var int
     *
