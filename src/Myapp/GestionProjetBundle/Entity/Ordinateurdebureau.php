 ...
 * Ordinateurdebureau
 *
 * @ORM\Table(name="ordinateurdebureau")
 * @ORM\Entity(repositoryClass="Myapp\GestionProjetBundle\Repository\OrdinateurdebureauRepository")
 */
class Ordinateurdebureau
{
    /**
     * @var int
     *
