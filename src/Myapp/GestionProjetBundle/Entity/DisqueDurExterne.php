 ...
 * DisqueDurExterne
 *
 * @ORM\Table(name="disque_dur_externe")
 * @ORM\Entity(repositoryClass="Myapp\GestionProjetBundle\Repository\DisqueDurExterneRepository")
 */
class DisqueDurExterne
{
    /**
     * @var int
     *
