...
/**
 * Cartouchesimprimante
 *
 * @ORM\Table(name="cartouchesimprimante")
 * @ORM\Entity(repositoryClass="Myapp\GestionProjetBundle\Repository\CartouchesimprimanteRepository")
 */
class Cartouchesimprimante
{
    /**
     * @var int
     *
